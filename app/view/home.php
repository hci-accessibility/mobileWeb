...
<div data-role="page" id = "pageone">
  ...
  <a href="about" data-role="button" style="width: 70%; margin:auto;">About Us</a>
  <button class="mediumbtn" style="width: 80%; margin:auto; margin-top:30px;"><a href="signup">Visiting</a></button>
  <button class="mediumbtn" style="width: 80%; margin:auto; margin-top:20px;"><a href="signin">Returning</a></button>
